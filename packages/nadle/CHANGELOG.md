...
## [0.5.4](https://github.com/nadlejs/nadle/compare/nadle/v0.5.3...nadle/v0.5.4) (2026-06-14)
...
* Add agent output reporter ([#586](https://github.com/nadlejs/nadle/issues/586)) ([ae0e46c](https://github.com/nadlejs/nadle/commit/ae0e46c0cab4b51b6be61c5ffce7112db55ce8ad))
* Add filter option to PnpmTask for workspace scoping ([#590](https://github.com/nadlejs/nadle/issues/590)) ([fc43435](https://github.com/nadlejs/nadle/commit/fc43435aba51eb9391976dc961ed0b476e8dc333))
* Add MoveTask and SyncTask builtin tasks ([#609](https://github.com/nadlejs/nadle/issues/609)) ([9dad1cb](https://github.com/nadlejs/nadle/commit/9dad1cb4b612e940e10212e370b5ad0900eea0a0))
* Add NadleError subclass hierarchy for catchable error types ([#582](https://github.com/nadlejs/nadle/issues/582)) ([884ad76](https://github.com/nadlejs/nadle/commit/884ad76352fc1fb0934c6fc441b3a72202f8eb5d))
...
* Add ZipTask, UnzipTask, and DownloadTask builtin tasks ([#610](https://github.com/nadlejs/nadle/issues/610)) ([f215b87](https://github.com/nadlejs/nadle/commit/f215b873d3c5be04fd8c54ed30f3260623ae6356))
* Allow omitting optionsResolver for tasks with no required options ([#588](https://github.com/nadlejs/nadle/issues/588)) ([f345d3b](https://github.com/nadlejs/nadle/commit/f345d3b1445bccb0049ec6300501d4268714b503))
...
* Support CLI argument passthrough to tasks via -- separator ([#599](https://github.com/nadlejs/nadle/issues/599)) ([74bc8af](https://github.com/nadlejs/nadle/commit/74bc8afcb32d6a8ea2950729827bfedacb0103e6))
* Support selecting tasks by glob pattern ([#591](https://github.com/nadlejs/nadle/issues/591)) ([d96ddf9](https://github.com/nadlejs/nadle/commit/d96ddf99e062dfa960fa07a9c4487d097e69870a))
...
* Validate configure() options at config-load time ([#593](https://github.com/nadlejs/nadle/issues/593)) ([3d83b63](https://github.com/nadlejs/nadle/commit/3d83b631a060cea57db2916a78d9e7950f0b59dc))
...
* Glob once in DeleteTask so logged paths match deleted paths ([#606](https://github.com/nadlejs/nadle/issues/606)) ([462aa35](https://github.com/nadlejs/nadle/commit/462aa357992b512609f5f9c122cd1b6f07bf1f8c))
...
* Print only one message when running empty tasks ([#474](https://github.com/nadlejs/nadle/issues/474)) ([7281ca0](https://github.com/nadlejs/nadle/commit/7281ca02d227700affafafea5b5f4147dd54f85e))
...
* Copy files concurrently in CopyTask ([#612](https://github.com/nadlejs/nadle/issues/612)) ([e5736c7](https://github.com/nadlejs/nadle/commit/e5736c7768512503b6e49079067f1534510605be))
* Run tasks in-process when max-workers is 1 ([#565](https://github.com/nadlejs/nadle/issues/565)) ([321c84e](https://github.com/nadlejs/nadle/commit/321c84e43556dc85acf5e36278dc993b06423d26))
...
* Add randomized parallelism ordering test ([#587](https://github.com/nadlejs/nadle/issues/587)) ([586491e](https://github.com/nadlejs/nadle/commit/586491e03b09019cef0a677ca4c4aadf6bafa5cf))
...
* Add workspaceFixture() helper for workspace test fixtures ([#571](https://github.com/nadlejs/nadle/issues/571)) ([9007703](https://github.com/nadlejs/nadle/commit/9007703c82c32d5e6ca87612e4dad5d724c05f08))
...
* **deps-dev:** Bump ts-morph from 27.0.2 to 28.0.0 ([#577](https://github.com/nadlejs/nadle/issues/577)) ([58d9c4b](https://github.com/nadlejs/nadle/commit/58d9c4bb62ee5c2c93f43abcc89e05b5e8dad0c5))
...
* Extract shared command runner for exec-based builtin tasks ([#607](https://github.com/nadlejs/nadle/issues/607)) ([d5873da](https://github.com/nadlejs/nadle/commit/d5873daef1657f4deb0bc6aa0432e896003ba93f))
...
* Remove dead helper and extract shared fixture utilities ([#569](https://github.com/nadlejs/nadle/issues/569)) ([b15f71c](https://github.com/nadlejs/nadle/commit/b15f71c0ef426731a2859e2a0ee66996ecf9aaa7))
...
* Remove Logger.throw() from public API ([#468](https://github.com/nadlejs/nadle/issues/468)) ([4c0f862](https://github.com/nadlejs/nadle/commit/4c0f8624469ac17fb6d7cb49557a315b3d7ac00c))
...
* Rewrite TaskScheduler tests as behavioral, split by concern ([#585](https://github.com/nadlejs/nadle/issues/585)) ([09fa7a0](https://github.com/nadlejs/nadle/commit/09fa7a0299ecd3a08e551fab90f3d7cf3391f94d))
...
* Unify result-awaiting behind a single settle() helper ([#570](https://github.com/nadlejs/nadle/issues/570)) ([b4eb0b3](https://github.com/nadlejs/nadle/commit/b4eb0b3e80fd12b2127a0d9a31e67a48cfbd5e26))
* Unify string args semantics across exec-based builtin tasks ([#613](https://github.com/nadlejs/nadle/issues/613)) ([53a5f51](https://github.com/nadlejs/nadle/commit/53a5f5102391c44b7e520c36cd6fd4cd8ce78144))
